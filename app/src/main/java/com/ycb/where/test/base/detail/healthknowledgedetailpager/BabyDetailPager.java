 ...
 * 孕婴界面
 */
public class BabyDetailPager extends BaseDetailPager {
    private RecyclerView mLvDetail;
    private SwipeRefreshLayout mSrl;
    private FrameLayout mFlPb;
    private ProgressBar mPb;
    private Button mReset;
    public BabyDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public void initData() {
        ...
        String babypager = sp.getString("babypager", "");
        if (TextUtils.isEmpty(babypager)){
            url = Url.BABYPAGER;
        }else{
            url = babypager;
        }
        ...
        MyGsonRequestUtils<HealthKnowledgeBean> socialHotspotBeanMyGsonRequestUtils = new MyGsonRequestUtils<>(Request
            ...
            public void onResponse(HealthKnowledgeBean response) {
                new HealthKnowledgeInitRecyclerView(response, mActivity,mLvDetail,mSrl,Url.BABYPAGER_TYPE,mFlPb,"babypager");
