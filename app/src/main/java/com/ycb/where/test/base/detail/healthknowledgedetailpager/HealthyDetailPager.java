 ...
 * 男性健康
 */
public class HealthyDetailPager extends BaseDetailPager {
    private RecyclerView mLvDetail;
    private SwipeRefreshLayout mSrl;
    private FrameLayout mFlPb;
    private ProgressBar mPb;
    private Button mReset;
    public HealthyDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public void initData() {
        ...
        String men_health = sp.getString("men_health", "");
        if (TextUtils.isEmpty(men_health)){
            url = Url.MEN_HEALTH;
        }else{
            url = men_health;
        }
        ...
        MyGsonRequestUtils<HealthKnowledgeBean> socialHotspotBeanMyGsonRequestUtils = new MyGsonRequestUtils<>(Request
            ...
            public void onResponse(HealthKnowledgeBean response) {
                 new HealthKnowledgeInitRecyclerView(response, mActivity,mLvDetail,mSrl,Url.MEN_HEALTH_TYPE, mFlPb,"men_health");
