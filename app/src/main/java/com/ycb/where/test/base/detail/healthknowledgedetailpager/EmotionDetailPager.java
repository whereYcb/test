 ...
 *
 */
public class EmotionDetailPager extends BaseDetailPager {
    private RecyclerView mLvDetail;
    private SwipeRefreshLayout mSrl;
    private FrameLayout mFlPb;
    private ProgressBar mPb;
    private Button mReset;
    public EmotionDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public void initData() {
        ...
        String marital_affection = sp.getString("marital_affection", "");
        if (TextUtils.isEmpty(marital_affection)){
            url = Url.MARITAL_AFFECTION;
        }else{
            url = marital_affection;
        }
        //创建请求对象
        MyGsonRequestUtils<HealthKnowledgeBean> socialHotspotBeanMyGsonRequestUtils = new MyGsonRequestUtils<>(Request
            ...
            public void onResponse(HealthKnowledgeBean response) {
               new HealthKnowledgeInitRecyclerView(response, mActivity,mLvDetail,mSrl,Url.MARITAL_AFFECTION_TYPE, mFlPb,"marital_affection");
