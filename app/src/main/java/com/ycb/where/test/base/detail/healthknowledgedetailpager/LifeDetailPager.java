 ...
 */
public class LifeDetailPager extends BaseDetailPager {
    private RecyclerView mLvDetail;
    private SwipeRefreshLayout mSrl;
    private FrameLayout mFlPb;
    private ProgressBar mPb;
    private Button mReset;
    public LifeDetailPager(Activity activity) {
        super(activity);
    }
    ...
    public void initData() {
        ...
        String private_life = sp.getString("private_life", "");
        if (TextUtils.isEmpty(private_life)){
            url = Url.PRIVATE_LIFE;
        }else{
            url = private_life;
        }
        //创建请求对象
        MyGsonRequestUtils<HealthKnowledgeBean> socialHotspotBeanMyGsonRequestUtils = new MyGsonRequestUtils<>(Request
            ...
            public void onResponse(HealthKnowledgeBean response) {
             new HealthKnowledgeInitRecyclerView(response, mActivity,mLvDetail,mSrl,Url.PRIVATE_LIFE_TYPE, mFlPb,"private_life");
